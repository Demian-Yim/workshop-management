        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="4자리 코드"
              className="w-full text-center text-3xl font-bold tracking-[0.5em] px-4 py-4 border-2 border-slate-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition"
            />
          </div>
          <div>
            ...
            <input
              ...
              placeholder="홍길동"
              className="w-full px-4 py-3 border-2 border-slate-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition text-lg"
            />
          </div>
